...
const PreferenceUI: React.FC = () => {
    ...
    const [sunnyActive, setSunnyActive] = useState(false); // Track visibility of genres
    ...
    const handleCheckboxChange = (
        ...
        setSelectedGenres((prevSelected) =>
            prevSelected.includes(genre)
                ? prevSelected.filter((g) => g !== genre) // Uncheck
                : [...prevSelected, genre] // Check
        );
    };
